---
title: Using Prisma with Next.js & TypeScript
date: '2022-04-09'
tags: ['Prisma', 'Next.js', 'ORM']
draft: false
summary: Integrate a Typescript first ORM to streamline your Database calls.
images: []
layout: PostLayout
canonicalUrl:
---

![prisma](/static/images/prisma.png)
...
- You will need to create to now create a `.env` file in your root directory to connect to your database. For this example,
...
- A directory `prisma` has been created which includes a `schema.prisma` file.
  This is where you setup your data source and create your database models.
...
- Finally let's put your hard work to the test and generate your database Schema & create a migration & run the seeder:
...
- Create a `lib` directory in your root directory and generate a file label `prisma.ts` with the following content:
...
## Part 2: Querying the database with Prisma & Next.js API routes
